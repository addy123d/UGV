...
def setup():
    ...
    return Right_PWM, Right_CW, Right_counter_CW, Left_PWM, Left_counter_CW, Left_CW, sensor_1, sensor_2
...
if __name__ == "__main__":
    ...
    delay_in_turn = 0.05
    Right_PWM, Right_CW, Right_counter_CW, Left_PWM, Left_counter_CW, Left_CW, sensor_1, sensor_2 = setup()
        ...
        while True:
            ...
            if(mode == "manual"):
                if(sensor_1_data == 0 and sensor_2_data == 0):
                        movement("STOP",Right_PWM,Left_PWM,Right_CW,Left_CW,Right_counter_CW,Left_counter_CW,R_PWM_value = 0,L_PWM_value=0)
                elif(sensor_1_data == 1 and sensor_2_data == 0):
                        movement("RIGHT",Right_PWM,Left_PWM,Right_CW,Left_CW,Right_counter_CW,Left_counter_CW,R_PWM_value = 60,L_PWM_value=60)
                        time.sleep(delay_in_turn*2)
                elif(sensor_1_data == 0 and sensor_2_data == 1):
                        movement("LEFT",Right_PWM,Left_PWM,Right_CW,Left_CW,Right_counter_CW,Left_counter_CW,R_PWM_value = 60,L_PWM_value=60)
                        time.sleep(delay_in_turn*2)
                else:
                        movement("FORWARD",Right_PWM,Left_PWM,Right_CW,Left_CW,Right_counter_CW,Left_counter_CW,R_PWM_value = 30,L_PWM_value=30)
            elif(mode == "auto"):
                pass
